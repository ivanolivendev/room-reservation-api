...
@Schema(description = "Payload para atualizacao completa de uma sala.")
public record UpdateRoomRequest(
        ...
        @Schema(description = "Indica se a sala esta ativa e pode receber novas reservas.", example = "true")
        @NotNull
        Boolean active
) {
}
